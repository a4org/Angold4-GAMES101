...
{
    // no need to do model transformation 
    // draw hard triangle in this example
...
{
    // Copy the projection matrix from last Assignment
...
int main(int argc, const char** argv)
{
    ...
    // The coordinates of the three vertices of two triangles
